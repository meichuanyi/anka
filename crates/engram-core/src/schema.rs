//! SQLite schema for an Engram collection.
...
-- Maps Anki ids → Engram ids for export fidelity.
...
CREATE INDEX IF NOT EXISTS idx_anki_id_map_engram ON anki_id_map(kind, engram_id);
"#;
